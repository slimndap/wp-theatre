...
(function ($) {
  ...
  wpt_editor = (function() {
    function wpt_editor() {
      this.init_datetime_inputs();
      this.init_delete_links();
    }

    wpt_editor.prototype.init_datetime_inputs = function() {
      this.event_date = jQuery('#wpt_event_editor_event_date').datetimepicker({
        defaultValue: wpt_editor_defaults.event_date
      });
      this.endtime = jQuery('#wpt_event_editor_enddate').datetimepicker();
      return this.event_date.change((function(_this) {
        return function() {
          var event_date_value;
          event_date_value = _this.event_date.datetimepicker('getDate');
          if (event_date_value != null) {
            event_date_value.setSeconds(event_date_value.getSeconds() + wpt_editor_defaults.duration);
            return _this.endtime.datetimepicker('setDate', event_date_value);
          }
        };
      })(this));
    };

    wpt_editor.prototype.init_delete_links = function() {
      return jQuery('.wpt_event_editor_event_action_delete').click((function(_this) {
        return function(e) {
          var data;
